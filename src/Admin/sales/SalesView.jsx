                    ...
                    Sales?.map((member, index) => {
                      ...
                      return (
                        <div
                          ...
                          className={`sales-card relative bg-white border border-[#ECEDF2] rounded-3xl p-4 transition-all duration-200 shadow-sm hover:shadow-[0_4px_20px_rgba(20,22,26,0.06)] hover:-translate-y-0.5 ${
