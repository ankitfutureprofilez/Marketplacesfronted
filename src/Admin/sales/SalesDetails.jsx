        ...
        <div className="bg-white rounded-[20px] mb-[10px] p-2">
          <div className="flex flex-col sm:flex-row justify-between items-center p-4 bg-white rounded-lg shadow mb-6 border border-gray-100">
            ...
            <div className="flex flex-wrap justify-center sm:justify-end items-center gap-4 text-sm text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <a href={`mailto:${record?.sales?.email || "N/A"}`} className="font-medium">
              ...
              <div className="flex items-center space-x-1">
                ...
                <a href={`tel:${record?.sales?.phone || "N/A"}`} className="font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              { 
                label: "Active Offers", 
                value: record?.total_offer_stats?.activeOffers || 0 
              },
              {
                label: "Offers Sold",
                value: record?.total_offer_stats?.totalOfferBuys || 0,
              },
              {
                label: "Redeemed Offers",
                value: record?.total_offer_stats?.redeemedOffers || 0,
              },
              {
                label: "Total Earnings",
                value: record?.total_offer_stats?.totalAmount || 0,
              },
            ].map((stat, index) => (
              <div
                key={index}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {record?.vendors && record?.vendors?.map((v, i) => (
              <Link
              to={`/vendor/${v?._id}`}
                key={i}
              ...
              >
                ...
                <div className="mt-4">
                  ...
                  <div className="max-h-[400px] overflow-y-auto border p-2 rounded-md text-sm bg-gray-50">
                    {Object.entries(v?.opening_hours).map(
                      ([day, info], idx) => (
                        <div
                          key={idx}
